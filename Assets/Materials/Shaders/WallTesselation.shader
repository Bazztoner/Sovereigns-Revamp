...
Shader "WallTesselation"
{
	Properties
	{
		...
		_Intensity("Intensity", Range( 0 , 0.35)) = 0
		_SubDivisions("SubDivisions", Range( 1 , 100)) = 1
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float2 uv_InnerWalls_InnerWalls_AlbedoTransparency_DISP = v.texcoord * _InnerWalls_InnerWalls_AlbedoTransparency_DISP_ST.xy + _InnerWalls_InnerWalls_AlbedoTransparency_DISP_ST.zw;
			v.vertex.xyz += ( ( float4( ase_vertexNormal , 0.0 ) * tex2Dlod( _InnerWalls_InnerWalls_AlbedoTransparency_DISP, float4( uv_InnerWalls_InnerWalls_AlbedoTransparency_DISP, 0, 0.0) ) ) * _Intensity ).rgb;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = tex2D( _InnerWalls_InnerWalls_AlbedoTransparency, uv_InnerWalls_InnerWalls_AlbedoTransparency ).rgb;
...
/*ASEBEGIN
Version=13701
342;105;810;556;700.0098;-356.903;1;True;False
Node;AmplifyShaderEditor.SamplerNode;1;-845.1219,641.5093;Float;True;Property;_InnerWalls_InnerWalls_AlbedoTransparency_DISP;InnerWalls_InnerWalls_AlbedoTransparency_DISP;0;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.NormalVertexDataNode;10;-696.9233,359.4114;Float;True;0;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;8;-380.0162,680.4315;Float;False;Property;_Intensity;Intensity;4;0;0;0;0.35;0;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;6;-336.1458,513.8731;Float;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-187.8116,551.4521;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.RangedFloatNode;9;-359.5432,760.1909;Float;False;Property;_SubDivisions;SubDivisions;5;0;1;1;100;0;1;FLOAT
Node;AmplifyShaderEditor.SamplerNode;4;-538.8605,-124.5617;Float;True;Property;_InnerWalls_InnerWalls_AlbedoTransparency;InnerWalls_InnerWalls_AlbedoTransparency;3;0;Assets/Materials/Temple/InnerWalls/InnerWalls_InnerWalls_AlbedoTransparency.tga;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-2,0;Float;False;True;6;Float;ASEMaterialInspector;0;0;Standard;WallTesselation;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;3000;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;True;0;4;10;25;True;1;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=FD3A3856BC6150FEEAFF856E88FC860B9492A0E6